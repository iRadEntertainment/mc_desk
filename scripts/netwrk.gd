...
func _on_user_connected(id):    print("user connected %s"%id)
func _on_user_disconnected(id): print("user disconnected %s"%id)
func _on_server_disconnected(): print("server offline")
